...
int main()
{
    ...
    std::cout << "std::atomic<int> is always lock-free: " << std::boolalpha << std::atomic<int>::is_always_lock_free << std::endl;
    std::cout << "std::atomic<float> is lock-free: " << std::boolalpha << total_time.is_lock_free() << std::endl;
    std::cout << "std::atomic<float> is always lock-free: " << std::boolalpha << std::atomic<float>::is_always_lock_free << std::endl;
    std::cout << "std::atomic<double> is lock-free: " << std::boolalpha << average_time.is_lock_free() << std::endl;
    std::cout << "std::atomic<double> is always lock-free: " << std::boolalpha << std::atomic<double>::is_always_lock_free << std::endl;
